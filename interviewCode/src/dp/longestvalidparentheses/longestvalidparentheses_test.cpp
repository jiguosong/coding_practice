...
TEST(longestvalidparentheses, normal1)
{
	longestvalidparentheses tc;

	string str = ")()())";
	ASSERT_EQ(4, tc.longestValidParentheses(str));
}

TEST(longestvalidparentheses, normal2)
{
	longestvalidparentheses tc;

	string str = "()";
	ASSERT_EQ(2, tc.longestValidParentheses(str));
}
