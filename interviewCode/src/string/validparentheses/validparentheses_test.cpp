...
TEST(validparentheses, normal1)
{
	validparentheses tc;

	string s = "{{{}}}[]";
	ASSERT_TRUE(tc.validParentheses(s));
}


TEST(validparentheses, normal2)
{
	validparentheses tc;

	string s = "{{{}}[]";
	ASSERT_FALSE(tc.validParentheses(s));
}



TEST(validparentheses, normal3)
{
	validparentheses tc;
