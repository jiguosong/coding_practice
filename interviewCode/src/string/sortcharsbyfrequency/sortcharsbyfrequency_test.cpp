...
TEST(sortcharsbyfrequency, normal1)
{
	sortcharsbyfrequency tc;

	string str = "tree";
	string ans = tc.SortCharactersbyFrequency(str);
	ASSERT_EQ(ans, "eetr");
}

TEST(sortcharsbyfrequency, normal2)
{
	sortcharsbyfrequency tc;

	string str = "cccaaa";
	string ans = tc.SortCharactersbyFrequency(str);
	ASSERT_EQ(ans, "cccaaa");
}

TEST(sortcharsbyfrequency, normal3)
{
	sortcharsbyfrequency tc;
